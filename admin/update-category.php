...
<div class = "main-content">
    ...
    <?php 
      ...
      if(isset($_GET['id']))
      {
        ...
        if($count==1)
        {
         ...
         {
            //redirect to manage catefory with session message 
    ...
    if(isset($_POST['submit']))
    {
     ...
     //check whether the image is selceted ro not 
     ...
     {
        //category updated
        $_SESSION['update'] = "<div class = 'success'>Category Updated Successfully";
        echo '<script type="text/javascript">
                location.replace("'.SITEURL.'admin/manage-category.php"); </script>';
     }
     else
     {
        ...
        $_SESSION['update'] = "<div class = 'error'>Failed to Updated Category";
        echo '<script type="text/javascript">
                location.replace("'.SITEURL.'admin/manage-category.php"); </script>';
     }
